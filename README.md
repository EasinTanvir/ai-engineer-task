...
**Note:** `migrate:pdfs` chunks and embeds all 6 documents locally, which takes roughly 1 to 2 minutes. Please be patient and don't close the terminal or kill the process while it's running.
